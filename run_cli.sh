...
# promptway = own
python evaluate.py prompt_own=own append_label_length=-1
python evaluate.py prompt_own=own append_label_length=3
python evaluate.py prompt_own=own append_label_length=6
