...
python evaluate_for_test_prompter.py target_lm=llama2-chat "prompter_lm.model_name='/fs/ess/PAA0201/lzy37ld/why_attack/ckpt/prompter_victim=llama2-7b-chat_prompt_type=q_p_model_name=llama2-base_sample_way_and_n_sample=random_nsample=200_epoch_5/checkpoint-20000" "prompter_lm.show_name="debug_mode" data_args.split=${split} ppl=false s_p_t_dir=./debug_mode target_lm.generation_configs.max_new_tokens=100 generation_configs@prompter_lm=top_p prompter_lm.generation_configs.num_return_sequences=50
