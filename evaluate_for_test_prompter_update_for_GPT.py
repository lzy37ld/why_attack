...
def main(config: "DictConfig"):
    ...
    if config.target_lm.model_name.startswith("gpt-"):
        ...
        target_lm_fn = OpenaiModel(model_name=config.target_lm.model_name,system_message = config.target_lm.system_message,template = config.target_lm.template,stop_once_success = config.stop_once_success,config = config)
    else:        
