...
def main(args):
	...
	for q in q_s_harm:
		# breakpoint()
		assert len(q_s_harm[q]["beaver_scores"]) == len(q_s_harm[q]["target_lm_generations"])

		q_harms = deter_if_harm(q_s_harm[q]["beaver_scores"],q_s_harm[q]["target_lm_generations"],determine_way=args.determine_way)
		if any(q_harms):
